        ...
        >
          <GlassCard className="p-8 border-indigo-500/20 shadow-2xl">
            <div className="text-center space-y-2 mb-8">
              ...
              <h2 className="text-2xl font-bold text-white">Welcome back to Nova AI</h2>
              <p className="text-xs text-slate-400">Log in to access your saved AI chats and vision analysis.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="developer@novaai.com"
              ...
              <button
                type="button"
                onClick={fillDemo}
                className="w-full py-2 rounded-xl bg-slate-800/60 border border-slate-700/50 hover:bg-slate-800 text-slate-300 text-xs font-medium transition-colors"
              >
